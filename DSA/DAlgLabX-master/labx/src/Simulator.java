...
/**
 * The {@code Simulator} class runs a simulation of the collision system based
 * on data in the argument to the program, or found on file.
 * 
...
public class Simulator {
	 ...
	 * @return boolean: true if the contents of the string are indeed an integer,
	 *         false otherwise.
	 */
	...
	/**
	 * Creates an ArrayList of Particles for the simulation, based off of data from
	 * a Scanner.
	 * 
	 * @param inputScanner that has already been linked to the appropriate source
	 *                     for data
